...
positive_vocab = ['awesome', 'outstanding', 'fantastic', 'terrific', 'good', 'nice', 'great', 'gem',
                  'funny', 'wonderful', ':)', 'love', 'incredible',  ]
negative_vocab = ['bad', 'terrible', 'useless', 'hate', ':(', 'waste','awful', 'soulless', 'never'
				  ,'trash','shit', 'shitty', 'ass' ]
neutral_vocab = ['movie', 'sound', 'actors', 'words', 'OMG', 'fucking', 'instead','lmao']
